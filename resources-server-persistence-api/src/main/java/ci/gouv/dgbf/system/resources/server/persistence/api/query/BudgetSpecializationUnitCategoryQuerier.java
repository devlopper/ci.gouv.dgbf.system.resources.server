...
public interface BudgetSpecializationUnitCategoryQuerier extends Querier {
	...
	String QUERY_NAME_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING = "readAggregationOrderByCodeAscending";
	String QUERY_IDENTIFIER_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING = QueryIdentifierBuilder.getInstance().build(BudgetSpecializationUnitCategory.class, QUERY_NAME_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING);
	Map<String,Integer> QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING_TUPLE_FIELDS_NAMES_INDEXES = ResourceQuerier.deriveSumsTupleFieldsNamesIndexes(
	...
	String QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING_SELECT_FROM = 
			...
			;
	String QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING = 
			QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING_SELECT_FROM
			+" WHERE resource.budget.actVersion.code = :"+PARAMETER_NAME_BUDGETARY_ACT_VERSION_CODE+" "			
			+" GROUP BY t.identifier,t.code,t.name "
			+" ORDER BY t.code ASC"
			;
	
	String QUERY_NAME_READ_AGGREGATION_BY_SECTIONS_CODES_ORDER_BY_CODE_ASCENDING = "readAggregationBySectionsCodesOrderByCodeAscending";
	String QUERY_IDENTIFIER_READ_AGGREGATION_BY_SECTIONS_CODES_ORDER_BY_CODE_ASCENDING = QueryIdentifierBuilder.getInstance().build(BudgetSpecializationUnitCategory.class, QUERY_NAME_READ_AGGREGATION_BY_SECTIONS_CODES_ORDER_BY_CODE_ASCENDING);
	String QUERY_VALUE_READ_AGGREGATION_BY_SECTIONS_CODES_ORDER_BY_CODE_ASCENDING = 
			QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING_SELECT_FROM
	...
	String QUERY_NAME_READ_AGGREGATION_BY_SECTIONS_CODES_BY_TYPES_CODES_ORDER_BY_CODE_ASCENDING = "readAggregationOrderBySectionsCodesByTypesCodesAscending";
	String QUERY_IDENTIFIER_READ_AGGREGATION_BY_SECTIONS_CODES_BY_TYPES_CODES_ORDER_BY_CODE_ASCENDING = QueryIdentifierBuilder.getInstance().build(BudgetSpecializationUnitCategory.class, QUERY_NAME_READ_AGGREGATION_BY_SECTIONS_CODES_BY_TYPES_CODES_ORDER_BY_CODE_ASCENDING);
	String QUERY_VALUE_READ_AGGREGATION_BY_SECTIONS_CODES_BY_TYPES_CODES_ORDER_BY_CODE_ASCENDING = 
			QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING_SELECT_FROM
			+" WHERE activity.budgetSpecializationUnit.section.code IN :"+PARAMETER_NAME_SECTIONS_CODES
	...
	static void initialize() {
		QueryHelper.addQueries(Query.build(Query.FIELD_IDENTIFIER,BudgetSpecializationUnitCategoryQuerier.QUERY_IDENTIFIER_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING
				...
				,Query.FIELD_VALUE,QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING
				).setTupleFieldsNamesIndexes(QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING_TUPLE_FIELDS_NAMES_INDEXES)
			);
		
		QueryHelper.addQueries(Query.build(Query.FIELD_IDENTIFIER,BudgetSpecializationUnitCategoryQuerier.QUERY_IDENTIFIER_READ_AGGREGATION_BY_SECTIONS_CODES_ORDER_BY_CODE_ASCENDING
				,Query.FIELD_TUPLE_CLASS,BudgetSpecializationUnitCategory.class,Query.FIELD_RESULT_CLASS,BudgetSpecializationUnitCategory.class
				,Query.FIELD_VALUE,QUERY_VALUE_READ_AGGREGATION_BY_SECTIONS_CODES_ORDER_BY_CODE_ASCENDING
				).setTupleFieldsNamesIndexes(QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING_TUPLE_FIELDS_NAMES_INDEXES)
			);
		
		QueryHelper.addQueries(Query.build(Query.FIELD_IDENTIFIER,BudgetSpecializationUnitCategoryQuerier.QUERY_IDENTIFIER_READ_AGGREGATION_BY_SECTIONS_CODES_BY_TYPES_CODES_ORDER_BY_CODE_ASCENDING
				,Query.FIELD_TUPLE_CLASS,BudgetSpecializationUnitCategory.class,Query.FIELD_RESULT_CLASS,BudgetSpecializationUnitCategory.class
				,Query.FIELD_VALUE,QUERY_VALUE_READ_AGGREGATION_BY_SECTIONS_CODES_BY_TYPES_CODES_ORDER_BY_CODE_ASCENDING
				).setTupleFieldsNamesIndexes(QUERY_VALUE_READ_AGGREGATION_ORDER_BY_CODE_ASCENDING_TUPLE_FIELDS_NAMES_INDEXES)
			);
	}
}